...
```
    ...
    ## 
    ##   LaZerte, Stefanie E and Sam Albers (2018). weathercan: Download and format
    ##   weather data from Environment and Climate Change Canada. The Journal of
    ##   Open Source Software 3(22):571. doi:10.21105/joss.00571.
    ## 
    ...
    ##    bit64          4.8.0   2026-04-21 [1] CRAN (R 4.6.0)
    ...
    ##  P weathercan   * 0.7.8   2026-05-04 [?] local
    ##    whisker        0.4.1   2022-12-05 [1] CRAN (R 4.6.0)
