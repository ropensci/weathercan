...
```
    ...
    ## $ qual             <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
...
```
    ...
    ## [1] "2016-03-01 06:57:42 PST" "2016-03-01 06:58:41 PST" "2016-03-01 07:07:21 PST" "2016-03-01 07:32:34 PST"
    ## [5] "2016-03-01 07:32:35 PST"
...
```
    ...
    ##  0620000513:7624   Min.   :2016-03-01   Min.   :2016-03-01 06:57:42   1500:6370   Length   :16886   Length   :16886  
    ##  041868D861:2767   1st Qu.:2016-03-05   1st Qu.:2016-03-05 13:54:13   2100: 968   N.unique :    2   N.unique :    4  
    ##  0620000514:1844   Median :2016-03-09   Median :2016-03-09 16:54:47   2200:2266   N.blank  :    0   N.blank  :    0  
    ##  06200004F8:1386   Mean   :2016-03-08   Mean   :2016-03-09 07:30:05   2300:3531   Min.nchar:   11   Min.nchar:    2  
    ##  041868BED6: 944   3rd Qu.:2016-03-13   3rd Qu.:2016-03-13 07:24:58   2400:1477   Max.nchar:   18   Max.nchar:    3  
    ##  06200003BB: 708   Max.   :2016-03-16   Max.   :2016-03-16 15:39:30   2700:2274                                      
    ##  (Other)   :1613                                                                                                     
    ##         sex            site_name          lon              lat             temp       
    ##  Length   :16886   Length   :16886   Min.   :-120.4   Min.   :50.67   Min.   :-2.268  
    ##  N.unique :    3   N.unique :    1   1st Qu.:-120.4   1st Qu.:50.67   1st Qu.: 4.707  
    ##  N.blank  :    0   N.blank  :    0   Median :-120.4   Median :50.67   Median : 8.972  
    ##  Min.nchar:    1   Min.nchar:   12   Mean   :-120.4   Mean   :50.67   Mean   : 8.443  
    ##  Max.nchar:    1   Max.nchar:   12   3rd Qu.:-120.4   3rd Qu.:50.67   3rd Qu.:11.943  
...
```
    ...
    ## $ lon       <dbl> -120.3622, -120.3622, -120.3622, -120.3635, -120.3635, -120.3635, -120.3635, -120.3635, -120.3622, -120.3…
    ## $ lat       <dbl> 50.66967, 50.66967, 50.66967, 50.66938, 50.66938, 50.66938, 50.66938, 50.66938, 50.66967, 50.66967, 50.66…
    ## $ temp      <dbl> 2.396167, 2.397806, 2.424500, 2.508556, 2.508611, 2.508667, 2.508722, 2.508778, 2.520278, 2.520500, 2.522…
...
```
    ...
    ## Warning: Removed 4001 rows containing missing values or values outside the scale range (`geom_point()`).
...
```
    ...
    ##         sex            site_name          lon              lat             temp       
    ##  Length   :16886   Length   :16886   Min.   :-120.4   Min.   :50.67   Min.   :-2.268  
    ##  N.unique :    3   N.unique :    1   1st Qu.:-120.4   1st Qu.:50.67   1st Qu.: 4.619  
    ##  N.blank  :    0   N.blank  :    0   Median :-120.4   Median :50.67   Median : 8.964  
    ##  Min.nchar:    1   Min.nchar:   12   Mean   :-120.4   Mean   :50.67   Mean   : 8.434  
    ##  Max.nchar:    1   Max.nchar:   12   3rd Qu.:-120.4   3rd Qu.:50.67   3rd Qu.:11.951  
    ##                                      Max.   :-120.4   Max.   :50.67   Max.   :16.353  
    ##                                                                       NAs    :195
...
```
    ...
    ##  Length   :16886   Length   :16886   Min.   :-120.4   Min.   :50.67   Min.   :-2.268   Min.   : 0.00  
    ##  N.unique :    3   N.unique :    1   1st Qu.:-120.4   1st Qu.:50.67   1st Qu.: 4.707   1st Qu.:10.27  
    ##  N.blank  :    0   N.blank  :    0   Median :-120.4   Median :50.67   Median : 8.972   Median :17.33  
    ##  Min.nchar:    1   Min.nchar:   12   Mean   :-120.4   Mean   :50.67   Mean   : 8.443   Mean   :16.79  
    ##  Max.nchar:    1   Max.nchar:   12   3rd Qu.:-120.4   3rd Qu.:50.67   3rd Qu.:11.943   3rd Qu.:22.10  
...
```
    ...
    ## $ lat       <dbl> 50.66967, 50.66967, 50.66967, 50.66938, 50.66938, 50.66938, 50.66938, 50.66938, 50.66967, 50.66967, 50.66…
    ## $ temp      <dbl> 2.396167, 2.397806, 2.424500, 2.508556, 2.508611, 2.508667, 2.508722, 2.508778, 2.520278, 2.520500, 2.522…
    ## $ wind_spd  <dbl> 19.00000, 19.00000, 18.51000, 16.82889, 16.82778, 16.82667, 16.82556, 16.82444, 16.59444, 16.59000, 16.54…
