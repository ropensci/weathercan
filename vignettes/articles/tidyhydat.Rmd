...
can compliment climate data from `weathercan` (and vice versa). 
...
## Exploring climate and hydraulogy

In the summer of 2020, my region (Brandon, Manitoba) experienced an incredibly 
heavy rain fall. Our downspout was ripped off the gutter and many people in the
...
dramatic increase in water flow in the Assiniboine (unsurprisingly). 

Let's add a bit of information about this lag.
