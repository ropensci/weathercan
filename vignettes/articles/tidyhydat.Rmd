...
## 1 MB    BRANDON A         50821 5010481     71140 YBR    49.9 -100.  409. Etc/G…
## 2 MB    BRANDON RCS       49909 5010490     71136 PBO    49.9 -100.  409. Etc/G…
...
<img src="figures/tidyhydat-unnamed-chunk-7-1.png" alt="plot of chunk unnamed-chunk-7" width="80%" />
...
##   <chr>          <chr>                    <chr>                  <dbl>     <dbl>
## 1 05MH001        ASSINIBOINE RIVER AT BR… MB                      49.9    -100. 
## 2 05MH006        LITTLE SOURIS RIVER NEA… MB                      49.7     -99.8
## 3 02OC007        MASKINONGE (LAC) A SAIN… QC                      46.3     -73.4
## 4 05MH013        ASSINIBOINE RIVER NEAR … MB                      49.9    -100.
```
...
## 1 05MH001        H         <NA>               2014    2023            10
## 2 05MH001        Q         <NA>               1906    2023            78
## 3 05MH006        H         <NA>               2002    2023            22
## 4 05MH006        Q         <NA>               1961    2023            63
```
...
<div class="figure" style="text-align: center">
<img src="figures/tidyhydat-unnamed-chunk-12-1.png" alt="plot of chunk unnamed-chunk-12" width="80%" />
...
<div class="figure" style="text-align: center">
<img src="figures/tidyhydat-unnamed-chunk-13-1.png" alt="plot of chunk unnamed-chunk-13" width="80%" />
...
<div class="figure" style="text-align: center">
<img src="figures/tidyhydat-unnamed-chunk-14-1.png" alt="plot of chunk unnamed-chunk-14" width="80%" />
...
<div class="figure" style="text-align: center">
<img src="figures/tidyhydat-unnamed-chunk-15-1.png" alt="plot of chunk unnamed-chunk-15" width="80%" />
...
ggplot() +
  ...
  scale_y_continuous(bquote(Total~Flow~(m^3/s)), expand = c(0, 0),
                     sec.axis = sec_axis(transforsm = ~ ./130 + min(level$Value) - 0.1,
                                         name = "Water Level (m)")) +
...
```
## Error in sec_axis(transforsm = ~./130 + min(level$Value) - 0.1, name = "Water Level (m)"): unused argument (transforsm = ~./130 + min(level$Value) - 0.1)
```
