...
`envirocan` is an R package for simplifying the downloading of Historical Climate Data from the [Environment and Climate Change Canada website](http://climate.weather.gc.ca/historical_data/search_historic_data_e.html)
...
`envirocan` includes a data frame called `stations` which lists available stations and their details (including `station_id`.
