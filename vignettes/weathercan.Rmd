...
```
## As of weathercan v0.3.0 time display is either local time or UTC See Details under ]8;;x-r-help:weather_dl`weather_dl()`]8;; for more information. This message
...
The current year range is 1991-2020, but you can also search for stations in the
previous year range:
...
Note that older normals have two parts to the data, average weather measurements and average frost dates.
