...
##  6 BC    KAMLOOPS A                51423 1163781     71887 YKA    50.7 -120.  345. Etc/GMT+8 day       2013  2022 FALSE   FALSE             FALSE            
##  7 BC    KAMLOOPS A                51423 1163781     71887 YKA    50.7 -120.  345. Etc/GMT+8 hour      2013  2022 FALSE   FALSE             FALSE            
...
## 10 BC    KAMLOOPS AUT              42203 1163842     71741 ZKA    50.7 -120.  345  Etc/GMT+8 day       2006  2022 FALSE   FALSE             FALSE            
## # … with 30 more rows
```
...
##  4 BC    KAMLOOPS A                   51423 1163781     71887 YKA    50.7 -120.  345. Etc/GMT+8 hour      2013  2022 FALSE   FALSE             FALSE            
##  5 BC    KAMLOOPS AFTON MINES          1276 1163790        NA <NA>   50.7 -120.  701  Etc/GMT+8 month     1977  1993 FALSE   FALSE             TRUE             
##  6 BC    KAMLOOPS AUT                 42203 1163842     71741 ZKA    50.7 -120.  345  Etc/GMT+8 hour      2006  2022 FALSE   FALSE             FALSE            
...
```
## # A tibble: 3 × 16
##   prov  station_name                station_id climate_id WMO_id TC_id   lat   lon  elev tz       interval start   end normals normals_1981_20… normals_1971_20…
##   <chr> <chr>                            <dbl> <chr>       <dbl> <chr> <dbl> <dbl> <dbl> <chr>    <chr>    <dbl> <dbl> <lgl>   <lgl>            <lgl>           
## 1 BC    CRESTON CAMPBELL SCIENTIFIC       6838 114B1F0     71770 WJR    49.1 -116.  641. Etc/GMT… hour      1994  2022 FALSE   FALSE            FALSE           
## 2 BC    NELSON CS                         6839 1145M29     71776 WNM    49.5 -117.  535. Etc/GMT… hour      1994  2022 FALSE   FALSE            FALSE           
## 3 BC    WARFIELD RCS                     31067 1148705     71401 XWF    49.1 -118.  567. Etc/GMT… hour      2001  2022 FALSE   FALSE            FALSE
```
...
<img src="figures/weathercan-unnamed-chunk-12-1.png" alt="plot of chunk unnamed-chunk-12" style="display: block; margin: auto;" />
...
```
## # A tibble: 13 × 203
##    prov  station_name           climate_id normals_years meets_wmo period temp_daily_aver… temp_daily_aver… temp_sd temp_sd_code temp_daily_max temp_daily_max_…
##    <chr> <chr>                  <chr>      <chr>         <lgl>     <fct>             <dbl> <chr>              <dbl> <chr>                 <dbl> <chr>           
##  1 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Jan               -16.4 A                    4.1 A                     -11.3 A               
##  2 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Feb               -13.2 A                    4.2 A                      -8.1 A               
##  3 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Mar                -5.8 A                    3.1 A                      -0.8 A               
##  4 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Apr                 4.4 A                    2.7 A                      10.9 A               
##  5 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      May                11.6 A                    2.1 A                      18.6 A               
##  6 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Jun                17   A                    2   A                      23.2 A               
##  7 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Jul                19.7 A                    1.4 A                      25.9 A               
##  8 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Aug                18.8 A                    1.9 A                      25.4 A               
##  9 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Sep                12.7 A                    1.3 A                      19   A               
## 10 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Oct                 5   A                    1.8 A                      10.5 A               
## 11 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Nov                -4.9 A                    3.6 A                      -0.5 A               
## 12 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Dec               -13.2 A                    4.4 A                      -8.5 A               
## 13 MB    WINNIPEG RICHARDSON I… 5023222    1981-2010     TRUE      Year                3   A                    1.2 A                       8.7 A               
...
```
## # A tibble: 7 × 14
##   prov  station_name            climate_id normals_years meets_wmo normals  frost_code date_first_fall… date_last_sprin… length_frost_fr… prob  prob_first_fall…
##   <chr> <chr>                   <chr>      <chr>         <lgl>     <list>   <chr>                 <dbl>            <dbl>            <dbl> <chr>            <dbl>
## 1 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 10%                255
## 2 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 25%                259
## 3 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 33%                261
## 4 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 50%                265
## 5 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 66%                268
## 6 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 75%                270
## 7 MB    WINNIPEG RICHARDSON IN… 5023222    1981-2010     TRUE      <tibble> A                       265              143              121 90%                276
...
##    prov  station_name           climate_id normals_years meets_wmo period temp_daily_aver… temp_daily_aver… temp_sd temp_sd_code temp_daily_max temp_daily_max_…
##    <chr> <chr>                  <chr>      <chr>         <lgl>     <fct>             <dbl> <chr>              <dbl> <chr>                 <dbl> <chr>           
##  1 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Jan               -17.8 A                    3.9 A                     -12.7 A               
##  2 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Feb               -13.6 A                    4.2 A                      -8.5 A               
##  3 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Mar                -6.1 A                    3.5 A                      -1.1 A               
##  4 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Apr                 4   A                    2.7 A                      10.3 A               
##  5 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      May                12   A                    2.5 A                      19.2 A               
##  6 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Jun                17   A                    1.8 A                      23.3 A               
##  7 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Jul                19.5 A                    1.5 A                      25.8 A               
##  8 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Aug                18.5 A                    1.8 A                      25   A               
##  9 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Sep                12.3 A                    1.4 A                      18.6 A               
## 10 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Oct                 5.3 A                    1.6 A                      10.8 A               
## 11 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Nov                -5.3 A                    3.3 A                      -0.9 A               
## 12 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Dec               -14.4 A                    4.2 A                      -9.7 A               
## 13 MB    WINNIPEG RICHARDSON I… 5023222    1971-2000     TRUE      Year                2.6 A                    1.3 A                       8.3 A               
