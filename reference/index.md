...
- [`flags`](https://docs.ropensci.org/weathercan/reference/flags.md) :
  Meaning of coded 'flags'
- [`glossary`](https://docs.ropensci.org/weathercan/reference/glossary.md)
...
- [`pg`](https://docs.ropensci.org/weathercan/reference/pg.md) : Hourly
  weather data for Prince George
- [`stations()`](https://docs.ropensci.org/weathercan/reference/stations.md)
  : Access Station data downloaded from Environment and Climate Change
  Canada
