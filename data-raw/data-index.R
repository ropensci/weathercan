...
f_names <- tribble(
  ...
  paste0("Probability of last temperature in spring of 0 ", "C or lower on or after indicated dates") ,                                     2 , "Probability of last temperature"  ,
  "prob_first_fall_temp_below_0_on_date"                                                              ,
  paste0("Probability of first temperature in fall of 0 ", "C or lower on or before indicated dates") ,                                     2 , "Probability of first temperature" ,
  "prob_length_frost_free"                                                                            ,
  paste0("Probability of frost-free period equal ", "to or less than indicated period (Days)")        ,                                     2 , "Probability of frost-free"        ,
