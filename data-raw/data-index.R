...
f_names <- c(
  "date_last_spring_frost" = "Average Date of Last Spring Frost",
  "date_first_fall_frost" = "Average Date of First Fall Frost",
  "length_frost_free" = "Average Length of Frost-Free Period",
  "prob_last_spring_temp_below_0_on_date" =
    paste0("Probability of last temperature in spring of 0 \U00B0",
           "C or lower on or after indicated dates"),
  "prob_first_fall_temp_below_0_on_date" =
    paste0("Probability of first temperature in fall of 0 \U00B0",
           "C or lower on or after indicated dates"),
  "prob_length_frost_free" = paste0("Probability of frost-free period equal ",
                                    "to or less than indicated period (Days)"),
