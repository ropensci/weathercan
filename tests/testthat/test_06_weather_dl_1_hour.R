...
test_that("weather (hour) verbose and quiet", {
  skip_on_cran()
  # Cached
  expect_message(weather_dl(c(1274, 1275), interval = "hour",
                            start = "2012-11-01", end = "2012-11-30"),
                 "There are no data")

  expect_silent(weather_dl(c(1274, 1274), interval = "hour",
                           start = "2012-11-01", end = "2012-11-30",
                           quiet = TRUE))
