...

    {
      ...
      "attributes": {
        "names": {
          "type": "character",
          "attributes": {},
          "value": ["station_name", "station_id", "station_operator", "prov", "lat", "lon", "elev", "climate_id", "WMO_id", "TC_id", "date", "year", "month", "mean_temp", "mean_temp_flag", "total_rain", "total_rain_flag", "total_snow", "total_snow_flag", "total_precip", "total_precip_flag", "dir_max_gust", "dir_max_gust_flag", "spd_max_gust", "spd_max_gust_flag", "mean_max_temp", "mean_max_temp_flag", "mean_min_temp", "mean_min_temp_flag", "extr_max_temp", "extr_max_temp_flag", "extr_min_temp", "extr_min_temp_flag", "snow_grnd_last_day", "snow_grnd_last_day_flag"]
        },
        "row.names": {
          "type": "integer",
          "attributes": {},
